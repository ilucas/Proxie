...
#warning added -w to Compiler Flags for Annoyng Unknow Warnings
...
-(void)awakeFromNib
{   
    surround = [[NSImage alloc] initByReferencingFile:[[NSBundle bundleForClass:[self class]] pathForResource:@"button_surround" ofType:@"png"]];
    knob = [[NSImage alloc] initByReferencingFile:[[NSBundle bundleForClass:[self class]] pathForResource:@"button_knob" ofType:@"png"]];
...
{          
    NSColor* darkWhite = [NSColor colorWithDeviceRed:0.63 green:0.63 blue:0.63 alpha:1.0];
    NSColor* lightWhite = [NSColor colorWithDeviceRed:0.847 green:0.835 blue:0.847 alpha:1.0];    
    ...
    NSGradient* green_gradient = [[NSGradient alloc] initWithStartingColor:darkWhite endingColor:lightWhite];
    ...
    NSMutableDictionary* attr = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                 ...
                                 [NSColor colorWithDeviceWhite:0.16 alpha:0.7], NSForegroundColorAttributeName,
                                 nil];
            ...
            switch ([localEvent type]) {
                ...
                case NSLeftMouseUp:
                    ...
                    if(location.x == 0 && state || location.x == KNOB_MAX_X && !state){
                        ...
                        [prefpane performSelector:@selector(switcher:) withObject:self];
                    }
